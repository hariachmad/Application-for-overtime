...
<body>
    <nav class="navbar">
        <div class="logo-container">
            <img src="/bluelake/public/image/bluelake logo.png" class="logo-image">
        ...
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="/bluelake/admin/index.php?url=home" class="nav-link">
            ...
            <li class="nav-item">
                <a href="/bluelake/admin/list-pengajuan" class="nav-link">
                    <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu">
                    ...
                    <li class="submenu-item"><a href="/bluelake/admin/tambah-karyawan" class="submenu-link">Tambah Karyawan</a></li>
                </ul>
            </li>
