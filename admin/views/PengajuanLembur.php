                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($row['foto_sebelum_path'])): ?>
                            <img src="<?php echo htmlspecialchars($row['foto_sebelum_path']); ?>" 
                                 alt="Foto Sebelum" 
                    ...
                    <td>
                        <?php if (!empty($row['foto_sesudah_path'])): ?>
                            <img src="<?php echo htmlspecialchars($row['foto_sesudah_path']); ?>" 
                                 alt="Foto Sesudah" 
                                 class="photo-evidence"
                                 style="max-width: 100px; height: auto;">
                        <?php else: ?>
                    ...
                    <td>
                        <?php if ($row['status_pengajuan'] === 'pending'): ?>
                            <form method="post" style="display: inline;">
                                ...
                                <button type="submit" class="action-btn approve-btn" style="background-color: #28a745; color: white; border: none; border-radius: 4px; padding: 8px 16px; cursor: pointer; margin-right: 4px;">
                                    Approve
                                </button>
                            </form>
                            <form method="post" style="display: inline;">
                                ...
                                <button type="submit" class="action-btn reject-btn" style="background-color: #dc3545; color: white; border: none; border-radius: 4px; padding: 8px 16px; cursor: pointer;">
                                    Reject
                                </button>
                            </form>
                        <?php else: ?>
